...
> [← 返回 P2 支付协议](../P2/) | 接口 ID: `IF_SYS_T3` | 类型: **系统** | schemaKind: **legacy-stub**
...
- kind=`legacy-stub`：guard 表达式含中文标点，自然语言未机械提取：回调签名校验失败且重试次数超限
