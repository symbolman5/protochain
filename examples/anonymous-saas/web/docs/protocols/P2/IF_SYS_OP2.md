...
> [← 返回 P2 资源发布与兑现](../P2/) | 接口 ID: `IF_SYS_OP2` | 类型: **系统** | schemaKind: **legacy-stub**
...
资源.形态=短时内网映射 ∧ 资源.处置状态=正常

## 前置条件（结构化）

- kind=`legacy-stub`：guard 表达式含中文标点，自然语言未机械提取：资源.形态=短时内网映射 ∧ 资源.处置状态=正常
